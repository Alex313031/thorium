...
> - Includes installer patches and files to include ChromeDriver and Content-Shell, with a .desktop file being provided for content_shell (named Thorium Content Shell.)
